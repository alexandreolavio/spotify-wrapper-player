...
import AlbumInfoView from '../app/js/views/AlbumListView';
import Helper from '../app/js/helpers/Helper';

describe('AlbumList', () => {
  it('should exist', () => {
    expect(AlbumInfoView).to.exist;
  });
  ...
  it('should create and append when more than 1 album', () => {
    ...
    const albumInfoView = new AlbumInfoView(element2);
    albumInfoView.update(data2);
